...
//		config.addGameLevel(RunConfig.GamesValidation2014.WHACKAMOLE, new int[] {1,2,3,4});
		...
		// GamesTraining2015
//		config.addGameLevel(RunConfig.GamesTraining2015.BAIT ,new int[] {1,2,3,4} );
		config.addGameLevel(RunConfig.GamesTraining2015.BOLOADVENTURES ,new int[] {1,2,3,4} );
//		config.addGameLevel(RunConfig.GamesTraining2015.BRAINMAN ,new int[] {1,2,3,4} );
...
//		config.addGameLevel(RunConfig.GamesTraining2015.REALSOKOBAN ,new int[] {1,2,3,4} );
